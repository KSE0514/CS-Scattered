# Ch5. 네트워크
- [Ch5. 네트워크](#ch5-네트워크)
- [Ch.5-1 네트워크의 큰 그림](#ch5-1-네트워크의-큰-그림)
  ...
  - [두 호스트가 패킷을 주고받는 과정](#두-호스트가-패킷을-주고받는-과정)
    ...
    - [네트워크 참조 모델](#네트워크-참조-모델)
      - [OSI 모델(OSI 7계층)](#osi-모델osi-7계층)
      - [TCP/IP모델(TCP/IP 4계층)](#tcpip모델tcpip-4계층)
    - [캡슐화, 역캡슐화](#캡슐화-역캡슐화)
- [Ch.5-2 물리 계층과 데이터 링크 계층](#ch5-2-물리-계층과-데이터-링크-계층)
  - [이더넷(Ethernet)](#이더넷ethernet)
    - [이더넷 표준](#이더넷-표준)
    - [이더넷 프레임(Ethernet Frame)](#이더넷-프레임ethernet-frame)
  - [유무선 통신 매체](#유무선-통신-매체)
    - [유선 매체 - 트위스티드 페어 케이블(Twisted Pair Cable)](#유선-매체---트위스티드-페어-케이블twisted-pair-cable)
...
- [Question](#question)
  - [Q1. 브로드캐스트와 유니캐스트를 비교해서 설명해주세요.](#q1-브로드캐스트와-유니캐스트를-비교해서-설명해주세요)
  - [Q2. 캡슐화와 역캡슐화에 대해 설명해주세요.](#q2-캡슐화와-역캡슐화에-대해-설명해주세요)
  - [Q3. 물리계층의 허브와 데이터링크 계층의 스위치를 비교해주세요.](#q3-물리계층의-허브와-데이터링크-계층의-스위치를-비교해주세요)
...
- 계층별 패킷 이름
  ...
  | 전송 계층     | TCP 기반 패킷의 경우: 세그먼트(segment) <br> UDP 기반 패킷의 경우: 데이터그램(datagram) |
