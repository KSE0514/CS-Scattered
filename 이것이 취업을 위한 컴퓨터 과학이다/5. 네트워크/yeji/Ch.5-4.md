# Ch.5-4 전송 계층 - TCP와 UDP
- [Ch.5-4 전송 계층 - TCP와 UDP](#ch5-4-전송-계층---tcp와-udp)
- [TCP와 UDP의 목적과 특징](#tcp와-udp의-목적과-특징)
  - [포트를 통한 프로세스 식별](#포트를-통한-프로세스-식별)
  - [2. 포트 번호](#2-포트-번호)
  - [3. NAT와 NAPT](#3-nat와-napt)
  - [4. TCP와 UDP의 차이점](#4-tcp와-udp의-차이점)
  - [5. TCP와 UDP 헤더 구조](#5-tcp와-udp-헤더-구조)
    - [5.1 UDP 헤더 구조](#51-udp-헤더-구조)
    - [5.2 TCP 헤더 구조](#52-tcp-헤더-구조)
  - [6. TCP의 연결 과정과 종료 과정](#6-tcp의-연결-과정과-종료-과정)
    - [6.1 TCP 연결 과정 (3-Way Handshake)](#61-tcp-연결-과정-3-way-handshake)
    - [6.2 TCP 연결 종료 (4-Way Handshake)](#62-tcp-연결-종료-4-way-handshake)
  - [7. TCP의 신뢰성 보장 기능](#7-tcp의-신뢰성-보장-기능)
    - [7.1 오류 제어](#71-오류-제어)
    - [7.2 흐름 제어 (Flow Control)](#72-흐름-제어-flow-control)
    - [7.3 혼잡 제어 (Congestion Control)](#73-혼잡-제어-congestion-control)
  - [8. TCP의 상태 관리 (Stateful Protocol)](#8-tcp의-상태-관리-stateful-protocol)
    - [8.1 연결 수립 안 되었을 때의 상태](#81-연결-수립-안-되었을-때의-상태)
    - [8.2 연결 수립 과정에서의 상태](#82-연결-수립-과정에서의-상태)
    - [8.3 연결 종료 과정에서의 상태](#83-연결-종료-과정에서의-상태)
- [Question](#question)
  - [Q1. TCP와 UDP의 차이점은 무엇인가요?](#q1-tcp와-udp의-차이점은-무엇인가요)
  - [Q2. NAT와 NAPT의 차이점은 무엇인가요?](#q2-nat와-napt의-차이점은-무엇인가요)
  - [Q3. TCP의 신뢰성 보장 기능에는 어떤 것들이 있나요?](#q3-tcp의-신뢰성-보장-기능에는-어떤-것들이-있나요)
