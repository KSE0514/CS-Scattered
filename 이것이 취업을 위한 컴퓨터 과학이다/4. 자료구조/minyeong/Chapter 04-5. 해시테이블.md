...
- 무작위 값 만들거나 단방향 암호 만들 때, **데이터의 무결성 검증**을 위해 사용함
    ...
    - 예시) 웹 서비스 접속 시 비밀번호 입력
        ...
        - 웹 프레임워크 단계에서 지원하는 경우 많음
            ...
            ![image.png](04-5/스프링해시.png)  
            
            자바 기반의 스프링 프레임워크(스프링 시큐리티)
                
            ![image.png](04-5/장고해시.png)  
...
![image.png](04-5/프로그래밍언어의해시테이블구현.png)
