...
- [Question](#question)
  - [Q1. SELECT 문의 실행 순서를 말해주세요.](#q1-select-문의-실행-순서를-말해주세요)
  - [Q2. 패턴 검색에서 LIKE 연산자와 와일드 카드 \&와 \_의 의미는 무엇인가요?](#q2-패턴-검색에서-like-연산자와-와일드-카드-와-_의-의미는-무엇인가요)
  - [Q3. DROP과 TRUNCATE 명령어의 차이를 비교해주세요.](#q3-drop과-truncate-명령어의-차이를-비교해주세요)
